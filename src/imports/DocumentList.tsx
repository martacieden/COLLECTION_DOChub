import svgPaths from "./svg-sp6lr7not4";
...
function DefaultButton2() {
  return (
    <div className="bg-[#f0f0f3] box-border content-stretch flex gap-[4px] h-[32px] items-center justify-center overflow-clip px-[12px] py-[6px] relative rounded-[6px] shrink-0" data-name="Default Button">
      <Sparkles />
...
function SearchButton() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Search button">
      <DefaultButton2 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="upload">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="upload">
          <g id="shape">
            <path clipRule="evenodd" d={svgPaths.p7a6dc80} fill="var(--fill-0, white)" fillRule="evenodd" />
            <path clipRule="evenodd" d={svgPaths.p2968ef00} fill="var(--fill-0, white)" fillRule="evenodd" />
            <path clipRule="evenodd" d={svgPaths.p34396780} fill="var(--fill-0, white)" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function TableNav() {
  return (
    <div className="bg-white h-[44px] relative shrink-0 w-full" data-name="Table nav">
      <div aria-hidden="true" className="absolute border-[#e8e8ec] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[44px] items-center justify-between px-[16px] py-[12px] relative w-full">
          <QuickFilters />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#fcfcfd] h-[36px] relative shrink-0 w-full" data-name="Table cell">
      ...
      <div className="flex flex-row items-center justify-end size-full">
        <div className="box-border content-stretch flex h-[36px] items-center justify-end pl-[8px] pr-0 py-[8px] relative w-full">
          <ExpandIcon />
        </div>
      </div>
    </div>
...
function TableCell2() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="Table cell">
      <div aria-hidden="true" className="absolute border-[#e8e8ec] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center justify-end size-full">
        <div className="box-border content-stretch flex h-[36px] items-center justify-end pl-[8px] pr-0 py-[8px] w-full" />
      </div>
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="basis-0 bg-white grow h-[36px] min-h-px min-w-px relative shrink-0" data-name="Table cell">
      <div aria-hidden="true" className="absolute border-[#e8e8ec] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center justify-end size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[36px] items-center justify-end px-[16px] py-[8px] relative w-full">
          <IconButton2 />
        </div>
      </div>
    </div>
...
function TableCell4() {
  return (
    <div className="bg-white h-[36px] relative shrink-0 w-full" data-name="Table cell">
      <div aria-hidden="true" className="absolute border-[#e8e8ec] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[36px] items-center pl-[16px] pr-0 py-[8px] relative w-full">
          <Avatar2 />
...
function TableCell47() {
  return (
    <div className="bg-white h-[36px] relative shrink-0 w-full" data-name="Table cell">
      <div aria-hidden="true" className="absolute border-[#e8e8ec] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[4px] h-[36px] items-center px-[16px] py-[8px] relative w-full">
          <Badge6 />
          <Badge7 />
        </div>
      </div>
...
function Badge8() {
  return (
    <div className="bg-[#f9f9fb] relative rounded-[6px] shrink-0" data-name="Badge">
      <div className="box-border content-stretch flex gap-[4px] items-center overflow-clip px-[6px] py-[2px] relative rounded-[inherit]">
        <ArrowRampRight />
...
function UserStacks() {
  return (
    <div className="box-border content-stretch flex items-center pl-0 pr-[4px] py-0 relative shrink-0" data-name="user stacks">
      <UserVoted />
      <UserVoted1 />
      <Avatar20 />
    </div>
...
function BadgeBase() {
  return (
    <div className="bg-[#e6f6eb] box-border content-stretch flex gap-[4px] h-[20px] items-center justify-center px-[6px] py-[2px] relative rounded-[6px] shrink-0" data-name="_Badge base">
...
function Badge26() {
  return (
    <div className="content-stretch flex gap-[4px] h-[20px] items-center justify-center relative rounded-[6px] shrink-0" data-name="Badge">
      <BadgeBase />
    </div>
  );
}
...
function BadgeBase1() {
  return (
    <div className="bg-[#ffefd6] box-border content-stretch flex gap-[4px] h-[20px] items-center justify-center px-[6px] py-[2px] relative rounded-[6px] shrink-0" data-name="_Badge base">
...
function BadgeBase2() {
  return (
    <div className="bg-[#ebf3ff] box-border content-stretch flex gap-[4px] h-[20px] items-center justify-center px-[6px] py-[2px] relative rounded-[6px] shrink-0" data-name="_Badge base">
...
function AllColumns() {
  return (
    <div className="basis-0 bg-white box-border content-stretch flex grow isolate items-start mb-[-1px] min-h-px min-w-px relative shrink-0 w-full" data-name="All columns">
      <Columns />
      <Columns1 />
      <Columns2 />
      <Columns3 />
  ...
  return (
    <div className="bg-white mb-[-1px] relative shrink-0 w-full" data-name="Bottom">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex font-['Inter:Medium',sans-serif] gap-[16px] items-center leading-[0] not-italic pl-[16px] pr-[24px] py-[8px] relative text-[#60646c] text-[13px] text-nowrap w-full whitespace-pre">
...
function Table5() {
  return (
    <div className="box-border content-stretch flex flex-col h-[704px] items-start pb-px pt-0 px-0 relative shrink-0 w-full" data-name="Table">
      <AllColumns />
      <Bottom />
    </div>
  );
...
function Content() {
  return (
    <div className="absolute content-stretch flex flex-col h-[900px] items-start right-0 top-0 w-[1368px]" data-name="Content">
      <TopHeader />
      <PageHeader />
      <Table6 />
    </div>
...
function Sparkles1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Sparkles">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Sparkles">
          <path clipRule="evenodd" d={svgPaths.pccd4000} fill="var(--fill-0, white)" fillRule="evenodd" id="shape" />
        </g>
      </svg>
    </div>
  );
...
function AiAssistantButton() {
  return (
    <div className="absolute bg-[#005be2] bottom-[16px] box-border content-stretch flex gap-[8px] h-[36px] items-center justify-center px-[16px] py-[6px] right-[16px] rounded-[32px] shadow-[0px_12px_32px_-16px_rgba(0,0,51,0.06),0px_8px_40px_0px_rgba(0,0,0,0.05)]" data-name="AI assistant button">
      <Sparkles1 />
      <p className="font-['Inter:Semi_Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[13px] text-nowrap text-white whitespace-pre">Ask Fojo</p>
    </div>
  );
}
...
export default function DocumentList() {
  return (
    <div className="bg-white relative size-full" data-name="Document list">
      <Content />
      <AiAssistantButton />
      <Sidenav />
    </div>
